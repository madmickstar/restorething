...
-nd | switch | -nd | disabled | Excludes restoring files that have been deleted or changed due to renaming, by default deleted or renamed files are included in restore
